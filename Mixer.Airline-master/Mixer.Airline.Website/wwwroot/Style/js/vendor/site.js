...
$(window).scroll(function () {
    ...
    ($(this).scrollTop() > offset) ? $navbar.addClass('stiky') : $navbar.removeClass('stiky');
...
//    $('#card_number').on('keydown', function (evt) {
//        var key = evt.charCode || evt.keyCode || 0;

//        let l = $('#card_number').val().length;
//        if (key != 8) {
...
//        } else {
//            if (l == 16 || l == 11 || l == 6)
//                $('#card_number').val($('#card_number').val().substring(0, l - 1));
//        }
...
//    $('#card_number').on('keyup', function (evt) {
